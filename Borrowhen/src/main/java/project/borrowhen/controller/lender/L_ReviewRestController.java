...
@RestController
public class L_ReviewRestController {

	@Autowired
    private BorrowRequestService borrowRequestService;

    @GetMapping("/api/lender/reviews")
    public BorrowRequestDto getReviews(@RequestParam(defaultValue = "0") int page,
        ...
        try {
            ...
            return borrowRequestService.getPaidBorrowRequestForLender(inDto);
